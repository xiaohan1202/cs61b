...
public class SimpleOomage implements Oomage {
    ...
    public boolean equals(Object o) {
        ...
        if (o.getClass() == this.getClass()){
            ...
            if (oomage.red == this.red && oomage.blue == this.blue && oomage.green == this.green) {
                return true;
            }
            else return false;
        }
    ...
    public int hashCode() {
        if (!USE_PERFECT_HASH) {
            ...
            int hash = 257 * red / 5 + 257 * 257 * green / 5 + 257 * 257 * 257 * blue / 5;// TODO: Write a perfect hash function for Simple Oomages.
            return hash;
        }
    }
